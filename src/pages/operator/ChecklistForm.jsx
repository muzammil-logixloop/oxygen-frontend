    ...
    <div className="max-w-4xl mx-auto">
      ...
      <div className="bg-slate-800/50 border border-white/5 rounded-2xl p-8">
        ...
        <div className="flex justify-between items-start mb-6">
          <div>
            <h1 className="text-2xl font-bold text-white mb-1">{type} Checklist</h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          {template.ChecklistItems.map(item => (
            <div key={item.itemId} className="p-5 bg-slate-900/30 rounded-xl border border-white/5">

              <div className="flex justify-between items-start mb-3">
                <div>
                  <h3 className="text-white font-semibold">{item.title}</h3>
                  <p className="text-slate-400 text-sm mt-1">{item.instruction}</p>
                </div>
              ...
              {item.requiresPhotoOnFail && responses[item.itemId] === 'Fail' && (
                <div className="mt-4">
                  <label className="text-slate-400 text-sm block mb-2">Photo Required</label>
          ...
          {type === 'Monthly' && (
            <div>
              <label className="text-slate-400 block mb-2">Monthly Video Upload (Required)</label>
              <input
                type="file"
                accept="video/*"
          ...
          <div>
            <label className="text-slate-400 block mb-2">General Notes</label>
            <textarea
              value={notesGeneral}
